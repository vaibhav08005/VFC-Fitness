...
const AICoach: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Coach VFC initialized. How can I help you craft your fitness today?' }
  ]);
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-white/10 bg-black/50 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display text-lg font-bold tracking-wider text-white">COACH VFC</h3>
              </div>
              <button 
